...
class AdminLoginSecuritySettingsTest extends TestCase
{
    ...
    public function test_admin_can_update_login_security_settings_within_allowed_range(): void
    {
        ...
        $payload['delay']['first_semester_end_day'] = 26;
        $payload['delay']['first_semester_end_month'] = 1;
        ...
        $this->assertDatabaseHas('delay_settings', [
            'first_semester_end_day' => 26,
            'first_semester_end_month' => 1,
        ]);
